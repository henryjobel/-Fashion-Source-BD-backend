...
const seedSettings = {
  ...
  favicon: "",
  footerLogo: "",
  email: "info@fashionsourcebd.com",
  phone: "+88-09606-333222",
  address: "Plot # 08, Road # 1/A, Gulshan-1, Dhaka-1212, Bangladesh.",
...
const seedPages = [
  ...
  pageSeed("/about", "About Us", "A sourcing partner built around practical garment execution.", "ABOUT US", [
    ...
    },
    {
      ...
      type: "cards",
      fields: [
        field("stat1", "Stat 1", "1998 - Industry Experience"),
        field("stat2", "Stat 2", "350+ - Skilled Employees"),
        field("stat3", "Stat 3", "100+ - Associated Factories"),
        field("stat4", "Stat 4", "4 - Key Locations"),
      ],
    },
    {
      id: "goal",
  ...
  pageSeed("/key-contacts", "Key Contacts", "Leadership contacts for business communication.", "KEY CONTACTS", [
    ...
    },
    {
      ...
      type: "cards",
      fields: [
        field("person1Name", "Person 1 Name", "Iqbal Khan Jamal"),
        field("person1Role", "Person 1 Role", "Managing Director and CEO"),
        field("person1Initials", "Person 1 Initials", "IK"),
        field("person1Email", "Person 1 Email", "office@fashionsourcebd.com"),
        field("person2Name", "Person 2 Name", "Nusrat Khan"),
        field("person2Role", "Person 2 Role", "Vice Chairman"),
        field("person2Initials", "Person 2 Initials", "NK"),
        field("person2Email", "Person 2 Email", "nusrat@fashionsourcebd.com"),
        field("person3Name", "Person 3 Name", "Arshad Jamal Khan"),
        field("person3Role", "Person 3 Role", "Director"),
        field("person3Initials", "Person 3 Initials", "AK"),
        field("person3Email", "Person 3 Email", "arshad@fashionsourcebd.com"),
        field("person4Name", "Person 4 Name", "Abul Kalam Azad"),
        field("person4Role", "Person 4 Role", "Chief Operating Officer"),
        field("person4Initials", "Person 4 Initials", "AA"),
        field("person4Email", "Person 4 Email", "azad@fashionsourcebd.com"),
      ],
    },
  ]),
  ...
  pageSeed("/why-work-with-us", "Why Work With Us", "Unique features that make us a trusted long-term sourcing partner.", "WHY CHOOSE FASHION SOURCE BD?", [
    {
      ...
      fields: [
        ...
        field("item2Title", "Item 2 Title", "Strong CSR Team"),
        field("item2Body", "Item 2 Body", "Our strong CSR team ensures Social Compliance per local and customer demands. A digital platform gives customers exact factory information on CSR issues.", "textarea"),
...
const seedNavigation = {
  header: [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Job Openings", url: "/job-openings", sort_order: 2 },
      ],
    },
  ...
  footer: [
    ...
    { label: "Career Opportunities", url: "/job-openings", group: "Company", sort_order: 7 },
